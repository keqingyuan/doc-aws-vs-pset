...
| 测试管理 |  | PSET的测试集成到了(MAM模块)目前支持的测试是jest puppeteer|
| 配置管理 |  |  |
| 介质管理 |  |  |
| 监控 | [Amazon CloudWatch](amazon-cloudwatch.md) 是AWS提供的监控服务，该服务集成到了[AWS CodeBuild](aws-codebuild.md)里。能对 | PSET的监控主要是在Monitor模块里。 |
