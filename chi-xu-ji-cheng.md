...
#### 开发架构模板后面的东西
这是一个构建需要填写的信息，总共分了项目配置信息、源码、环境、特殊构建、介质、日志6个块，对于一个新手而言填写完这些信息确实需要不少功夫，所以AWS提供了一套模板架构减少用户工作量的同时也规范了流程。
![build-info](/assets/2019-02-21_195908.png)
...
5. PSET对Docker镜像构建没有AWS丰富，AWS可以支持的基础镜像非常丰富，见[这里](https://docs.aws.amazon.com/zh_cn/codebuild/latest/userguide/build-env-ref-available.html) 。